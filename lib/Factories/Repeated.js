...
var Repeated = function (_t$form$Component) {
	...
	Repeated.prototype.componentWillReceiveProps = function componentWillReceiveProps(props) {
	...
	Repeated.prototype.componentWillMount = function componentWillMount(props) {
		ctx = this;
	};

	Repeated.prototype.onChangeRep = function onChangeRep(value) {
	...
	Repeated.prototype.renderInputs = function renderInputs() {
